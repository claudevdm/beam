...
def main():
  ...
  parser.add_argument(
      '--dataset', default='cvandermerwe_test', help='BigQuery dataset')
  ...
  parser.add_argument(
      '--temp_dataset',
      default='cvandermerwe_test',
      help='Dataset for temp tables')
  ...
  logging.warning(f"CLAUDE table {table}, temp_dataset {args.temp_dataset}")
