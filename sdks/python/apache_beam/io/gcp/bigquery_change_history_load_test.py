...
Usage (medium profile, DataflowRunner):
  python -m apache_beam.io.gcp.bigquery_change_history_load_test \
      --project=apache-beam-testing --dataset=cvandermerwe_test --profile=medium \
      --temp_location=gs://cvandermwerwe_test/staging \
      --staging_location=gs://cvandermwerwe_test/staging \
      --sdk_location=dist/apache_beam-2.73.0.dev0.tar.gz

 python -m apache_beam.io.gcp.bigquery_change_history_load_test --project=apache-beam-testing --dataset=cvandermerwe_test --profile=medium --temp_location=gs://cvandermwerwe_test/staging --staging_location=gs://cvandermwerwe_test/staging --sdk_location=dist/apache_beam-2.73.0.dev0.tar.gz
