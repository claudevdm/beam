...
public enum SchemaEvolutionOption {
   ...
   * statistics for it, or lacks it entirely (every row would read null). A file whose footer proves
   * zero nulls never triggers this, however its writer declared the column. Relaxation is
