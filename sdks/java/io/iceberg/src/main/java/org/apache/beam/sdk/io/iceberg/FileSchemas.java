 ...
 * by name at every level and renumbers ids in pre-order, so files that differ only in column order
 * produce identical JSON. Ids are positional and meaningless: the commit side reconciles columns by
 * name.
 */
